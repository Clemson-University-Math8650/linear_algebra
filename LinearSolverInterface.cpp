...
void 
LinearSolverInterface::
solveSystemCG(const std::shared_ptr<const SymmetricMatrix>& A, 
              const std::shared_ptr<const DenseVector>& rhs, 
              const std::shared_ptr<DenseVector>& sol)
{
  std::cout << "============ BEGIN Krylov Solver Step ======================" << std::endl;
  std::cout << std::endl;
  std::cout << std::endl;
  auto prec = std::make_unique<const JacobiPreconditioner<SymmetricMatrix,DenseVector>>(*A);
  int maxiter_ = maxiter;
  double tol_ = tol;
  const auto solver_tag = CG(*A,*sol,*rhs,*prec,maxiter_,tol_);
  if (solver_tag == 0)
...
void 
LinearSolverInterface::
solveSystemBiCG(const std::shared_ptr<const SymmetricMatrix>& A, 
                const std::shared_ptr<const DenseVector>& rhs, 
                const std::shared_ptr<DenseVector>& sol)  
{
  std::cout << "============ BEGIN Krylov Solver Step ======================" << std::endl;
...
void 
LinearSolverInterface::
solveSystemCG(const std::shared_ptr<const TridiagonalMatrix>& A, 
              const std::shared_ptr<const DenseVector>& rhs, 
              const std::shared_ptr<DenseVector>& sol)
{
  std::cout << "============ BEGIN Krylov Solver Step ======================" << std::endl;
  std::cout << std::endl;
  std::cout << std::endl;
  auto prec = std::make_unique<const JacobiPreconditioner<TridiagonalMatrix,DenseVector>>(*A);
  int maxiter_ = maxiter;
  double tol_ = tol;
  const auto solver_tag = CG(*A,*sol,*rhs,*prec,maxiter_,tol_);
  if (solver_tag == 0)
...
void 
LinearSolverInterface::
solveSystemBiCG(const std::shared_ptr<const TridiagonalMatrix>& A, 
                const std::shared_ptr<const DenseVector>& rhs, 
                const std::shared_ptr<DenseVector>& sol)  
{
  std::cout << "============ BEGIN Krylov Solver Step ======================" << std::endl;
...
void 
LinearSolverInterface::
solveSystemCG(const std::shared_ptr<const UpperTriangularMatrix>& A, 
              const std::shared_ptr<const DenseVector>& rhs, 
              const std::shared_ptr<DenseVector>& sol)
{
  std::cout << "============ BEGIN Krylov Solver Step ======================" << std::endl;
  std::cout << std::endl;
  std::cout << std::endl;
  auto prec = std::make_unique<const JacobiPreconditioner<UpperTriangularMatrix,DenseVector>>(*A);
  int maxiter_ = maxiter;
  double tol_ = tol;
  const auto solver_tag = CG(*A,*sol,*rhs,*prec,maxiter_,tol_);
  if (solver_tag == 0)
...
void 
LinearSolverInterface::
solveSystemBiCG(const std::shared_ptr<const UpperTriangularMatrix>& A, 
                const std::shared_ptr<const DenseVector>& rhs, 
                const std::shared_ptr<DenseVector>& sol)  
{
  std::cout << "============ BEGIN Krylov Solver Step ======================" << std::endl;
...
void 
LinearSolverInterface::
solveSystemCG(const std::shared_ptr<const LowerTriangularMatrix>& A, 
              const std::shared_ptr<const DenseVector>& rhs, 
              const std::shared_ptr<DenseVector>& sol)
{
  std::cout << "============ BEGIN Krylov Solver Step ======================" << std::endl;
  std::cout << std::endl;
  std::cout << std::endl;
  auto prec = std::make_unique<const JacobiPreconditioner<LowerTriangularMatrix,DenseVector>>(*A);
  int maxiter_ = maxiter;
  double tol_ = tol;
  const auto solver_tag = CG(*A,*sol,*rhs,*prec,maxiter_,tol_);
  if (solver_tag == 0)
...
void 
LinearSolverInterface::
solveSystemBiCG(const std::shared_ptr<const LowerTriangularMatrix>& A, 
                const std::shared_ptr<const DenseVector>& rhs, 
                const std::shared_ptr<DenseVector>& sol)  
{
  std::cout << "============ BEGIN Krylov Solver Step ======================" << std::endl;
